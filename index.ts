...
console.log("Usman Saeed"); //To show user output (on console)

var userName:string = "Usman"; // "var" is a reserved keyword for declaring a variable. "userName" is the name of variable
...
var userName2: string = "Saeed"; //Restricting the variable to only store "string" data.
